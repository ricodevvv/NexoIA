...
const TRUSTED = [
  "github.com", "*.github.com", "*.githubusercontent.com", "*.github.io", "ghcr.io", "gitlab.com", "*.gitlab.com",
  "bitbucket.org", "*.bitbucket.org", "codeberg.org", "*.googlesource.com", "sourceforge.net", "*.sourceforge.net",
  "registry.npmjs.org", "*.npmjs.org", "*.npmjs.com", "registry.yarnpkg.com", "*.yarnpkg.com", "nodejs.org", "*.nodejs.org",
  "jsr.io", "*.jsr.io", "deno.land", "*.deno.land", "bun.sh", "*.bun.sh", "esm.sh", "cdn.jsdelivr.net", "unpkg.com", "cdnjs.cloudflare.com",
  "pypi.org", "*.pypi.org", "files.pythonhosted.org", "*.pythonhosted.org", "*.python.org", "python.org", "astral.sh", "*.astral.sh",
  "conda.anaconda.org", "repo.anaconda.com", "*.anaconda.org", "*.anaconda.com", "prefix.dev", "*.prefix.dev",
  "download.pytorch.org", "*.pytorch.org", "huggingface.co", "*.huggingface.co", "*.hf.co", "developer.download.nvidia.com",
  "repo.maven.apache.org", "repo1.maven.org", "*.maven.org", "*.apache.org", "*.gradle.org", "jitpack.io", "repo.clojars.org",
  "maven.google.com", "dl.google.com", "repo.spring.io", "oss.sonatype.org", "s01.oss.sonatype.org", "*.sonatype.org",
  "pkgs.dev.azure.com", "download.jetbrains.com", "cache-redirector.jetbrains.com", "packages.jetbrains.team", "maven.pkg.jetbrains.space",
  "api.foojay.io", "api.adoptium.net", "*.adoptium.net", "cdn.azul.com", "download.java.net", "download.oracle.com", "corretto.aws",
  "maven.minecraftforge.net", "files.minecraftforge.net", "maven.neoforged.net", "maven.fabricmc.net", "meta.fabricmc.net",
  "maven.quiltmc.org", "meta.quiltmc.org", "maven.architectury.dev", "maven.parchmentmc.org", "repo.spongepowered.org",
  "repo.essential.gg", "repo.papermc.io", "hub.spigotmc.org", "repo.codemc.io", "repo.codemc.org", "maven.enginehub.org",
  "repo.extendedclip.com", "repo.opencollab.dev", "repo.velocitypowered.com", "maven.terraformersmc.com", "maven.shedaniel.me",
  "maven.blamejared.com", "maven.wispforest.io", "maven.ladysnake.org", "modmaven.dev", "cursemaven.com",
  "api.modrinth.com", "cdn.modrinth.com", "libraries.minecraft.net", "launchermeta.mojang.com", "piston-meta.mojang.com",
  "piston-data.mojang.com", "launcher.mojang.com", "resources.download.minecraft.net",
  "crates.io", "*.crates.io", "*.rust-lang.org", "sh.rustup.rs",
  "proxy.golang.org", "sum.golang.org", "*.golang.org", "go.dev", "*.go.dev", "gopkg.in",
  "rubygems.org", "*.rubygems.org", "packagist.org", "*.packagist.org", "getcomposer.org",
  "nuget.org", "*.nuget.org", "dot.net", "builds.dotnet.microsoft.com", "download.visualstudio.microsoft.com",
  "hex.pm", "*.hex.pm", "hackage.haskell.org", "*.haskell.org", "pub.dev", "*.pub.dev", "*.flutter.dev", "storage.googleapis.com",
  "cdn.cocoapods.org", "download.swift.org", "ziglang.org", "*.ziglang.org", "cmake.org", "*.cmake.org",
  "*.julialang.org", "*.r-project.org", "cran.rstudio.com", "packagemanager.posit.co", "*.metacpan.org", "*.cpan.org",
  "registry-1.docker.io", "auth.docker.io", "production.cloudflare.docker.com", "*.docker.io", "*.docker.com",
  "quay.io", "*.quay.io", "mcr.microsoft.com", "*.data.mcr.microsoft.com", "registry.k8s.io", "public.ecr.aws", "gcr.io", "*.pkg.dev",
  ...
  "ppa.launchpadcontent.net", "keyserver.ubuntu.com", "dl-cdn.alpinelinux.org", "*.alpinelinux.org",
  "fonts.googleapis.com", "fonts.gstatic.com", "models.dev",
];
